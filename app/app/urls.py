...
urlpatterns = [
    ...
    path('d/export/finance_payment_batch/csv/<str:node_id>/<str:token>',
    ...
    path('d/export/invoice/pdf/preview/<str:node_id>/<str:token>', views.invoice_pdf_preview,
         name="export_invoice_pdf_preview"),
    # path('d/export/invoices/<str:date_from>/<str:date_until>/<str:token>', views.invoices,
