  ...
  return {
    ...
    output: {
      ...
      filename: isEnvProduction
        ? 'fstatic/js/[name].[chunkhash:8].js'
        : isEnvDevelopment && 'static/js/bundle.js',
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? 'fstatic/js/[name].[chunkhash:8].chunk.js'
        ...
        },
        {
          ...
          oneOf: [
            ...
            // A missing `test` is equivalent to a match.
            {
              ...
              options: {
                limit: 10000,
                name: 'fstatic/media/[name].[hash:8].[ext]',
              },
            },
    ...
    plugins: [
      ...
      isEnvProduction &&
        new MiniCssExtractPlugin({
          ...
          filename: 'fstatic/css/[name].[contenthash:8].css',
          chunkFilename: 'fstatic/css/[name].[contenthash:8].chunk.css',
        }),
