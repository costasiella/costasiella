...
function OrganizationAnnouncementForm({ t, history, isSubmitting, errors, setFieldTouched, setFieldValue, returnUrl }) {
  <FoForm>
    <Card.Body>
      <Grid.Row>
        <Grid.Col>
      ...
      <Grid.Row>
        <Grid.Col>
          <Form.Group label={t('organization.annoncements.content')}>
            <Editor
