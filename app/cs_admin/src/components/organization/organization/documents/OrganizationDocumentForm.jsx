...
function OrganizationDocumentForm ({ t, history, values, isSubmitting, errors, return_url }) {
          ...
          <Grid.Col>
            <Form.Group label={t('general.custom_file_input_label')}>
              <div className="custom-file">
                <input type="file" ref={inputFileInput} className="custom-file-input" onChange={_handleOnChange} />
