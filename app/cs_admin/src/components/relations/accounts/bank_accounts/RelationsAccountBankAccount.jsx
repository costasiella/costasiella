...
function RelationsAccountBankAccount({ t, match, history }) {
  ...
  const account_bank_accounts = data.accountBankAccounts
  const account_bank_account = data.accountBankAccounts.edges[0]
...
// class RelationsAccountBankAccount extends Component {
//   constructor(props) {
//     super(props)
