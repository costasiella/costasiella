...
class ScheduleItemNode(DjangoObjectType):
    ...
    def get_node(self, info, id):
        ...
        require_login_and_permission(user, 'costasiella.view_schedule')

        return self._meta.model.objects.get(id=id)


class ScheduleQuery(graphene.ObjectType):
    schedule_items = DjangoFilterConnectionField(ScheduleNode)
    schedule_item = graphene.relay.Node.Field(ScheduleNode)
