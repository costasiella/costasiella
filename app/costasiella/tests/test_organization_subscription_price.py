...
class GQLOrganizationSubscriptionPrice(TestCase):
    ...
    def setUp(self):
        ...
        self.variables_create = {
            "input": {
                "organizationLocation": to_global_id('OrganizationSubscriptionNode', self.organization_subscription.pk),
                "displayPublic": True,
                "name": "First room",
            }
        }
...
'''
    ...
    def test_query(self):
        ...
        variables = {
            'organizationLocation': to_global_id('OrganizationSubscriptionNode', subscription_price.organization_subscription.pk),
            'archived': False
        }
        ...
        self.assertEqual(
            data['organizationSubscriptionPrices']['edges'][0]['node']['organizationLocation']['id'], 
            variables['organizationLocation']
        )
        self.assertEqual(data['organizationSubscriptionPrices']['edges'][0]['node']['name'], subscription_price.name)
        self.assertEqual(data['organizationSubscriptionPrices']['edges'][0]['node']['archived'], subscription_price.archived)
        self.assertEqual(data['organizationSubscriptionPrices']['edges'][0]['node']['displayPublic'], subscription_price.display_public)
    ...
    def test_query_one(self):
        ...
        data = executed.get('data')
        self.assertEqual(data['organizationSubscriptionPrice']['organizationLocation']['id'], 
    ...
    def test_create_subscription_price(self):
        ...
        data = executed.get('data')
        self.assertEqual(
          data['createOrganizationSubscriptionPrice']['organizationSubscriptionPrice']['organizationLocation']['id'], 
